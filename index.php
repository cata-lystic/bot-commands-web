...
// Advanced Config
$metaAuthor = "Catalyst";
$metaDescription = "Commands and information for JREbot Discord Bot";
...
// Load commands.json
$fo = fopen("app/commands.json", 'r');
$fr = fread($fo, filesize("app/commands.json"));
fclose($fo);
...
<header>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="app/img/logo.png" height="30" width="32" /> &nbsp;<?php echo $botName; ?> Commands</a>
      </div>
    </nav>
</header>
